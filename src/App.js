...
import {Devolucao} from './components/Relatorios/devoluçoes/devolucoes';
    ...
    <div className="App">
      ...
      {/* Rotas de navegação */}
          <Routes>
            ...
            <Route path = '/devolucao' element = {token ? (<><NavBar setCadastro={setCadastro} cadastro={cadastro} setModal={setModal} modal={modal} minimizado={minimizado} setMinimizado={setMinimizado}/><Devolucao/></>) : <Login/>}/>
          </Routes>
